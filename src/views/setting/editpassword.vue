...
<div class='app-container' v-loading="loading">
  <div class="tips dp-flex fl-al-center">
      <img src="/images/common/lock.png" alt="" class="lock">
      <p class="flex-1">如有其他问题，请联系平台方客服～</p>
  </div>
  <div class="item" style="margin-top:40px;">
    <div class="_item">
       <div class="head">旧密码</div>
       <el-input class="flex-1" v-model="oldpassword" placeholder="请输入旧密码"></el-input>
    </div>
  </div>
  <div class="item">
     <div class="_item">
       <div class="head">新密码</div>
       <el-input class="flex-1" v-model="newpassword" placeholder="请输入新密码"></el-input>
    </div>
  </div>
  <div class="item">
     <div class="_item">
       <div class="head">确认新密码</div>
       <el-input class="flex-1" v-model="renewpassword" placeholder="请重新输入密码"></el-input>
    </div>
  </div>
